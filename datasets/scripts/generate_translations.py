...
from datasets.scripts.constants import LANGUAGES, SELECTED_SENTENCES
...
class NLLBTranslate:
    ...
    def translate_all(self, texts: list, src_lang: str, target_lang: str = "eng_Latn"):
        ...
        for text in tqdm(texts):
            translation = self.translate_text(text, src_lang, target_lang)
...
if __name__ == "__main__":
    ...
    for flores_code, goog_code in LANGUAGES.items():
        ...
        for english_sentence, translation, back_translation in zip(SELECTED_SENTENCES, translations, llm_back_translations):
            translations_dict[english_sentence][flores_code] = {"original": translation, "llm_back_translation": back_translation}

    # Save the translations to a JSON file
    with open("./datasets/sample_translationstranslations.json", "w", encoding="utf-8") as f:
        import json
